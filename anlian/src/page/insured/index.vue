	...
	<div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="box">
                ...
                <p class="boxMessageWriteR"><input type="text" placeholder="请输入真实姓名"></p>
            </div>
            <div class="box">
                 <p class="boxMessageWriteL">手机号码</p>
                <p class="boxMessageWriteR"><input type="text" placeholder="请输入手机号" maxlength="11"></p>
            </div>
             <div class="box">
                 <p class="boxMessageWriteL">身份证号</p>
                <p class="boxMessageWriteR"><input type="text" placeholder="请输入身份证号" maxlength="18"></p>
            </div>
             <div class="box">
                 <p class="boxMessageWriteL">证件有效期</p>
                <p class="boxMessageWriteR identity">
                    <span class="identityChoose">请选择</span>
             ...
             <div class="box">
                ...
                <p class="boxMessageWriteR"><input type="text" placeholder="请输入邮箱号"><i data-v-19455e20 class="iconfont icon iconjiantouarrow487"></i></p>
            </div>
             <div class="box">
             ...
             <div class="box">
                ...
                <p class="boxMessageWriteR"><input type="text" placeholder="安徽省 合肥市 庐阳区" maxlength="11"></p>
            </div>
             <div class="box">
                 <p class="boxMessageWriteL">邮政编码</p>
                <p class="boxMessageWriteR"><input type="text" placeholder="请输入邮政编码"></p>
            </div>
            <div class="messageWrite">
                <p class="messageWriteL"></p>
             ...
             <div class="box">
                ...
                <p class="boxMessageWriteR"><input type="text" placeholder="请选择职业"></p>
            </div>
            <div class="messageWrite">
                <p class="messageWriteL"></p>
             ...
             <div class="box">
                ...
                <p class="boxMessageWriteR"><span class="interestsPeople">法定受益人</span></p>
            </div>
            <div class="accept">
                <div class="acceptContent">
                    <p class="acceptLeft"><input type="checkbox" class="acceptCheckBox"></p>
                    <p class="acceptRight">我已阅读并同意此保险的
